...
CREATE_ISSUE_ISSUE_TEMPLATE_PATH_DEFAULT = "" 
...
CREATE_ISSUE_ISSUE_TEMPLATE_PATH = os.environ.get('CREATE_ISSUE_ISSUE_TEMPLATE_PATH',CREATE_ISSUE_ISSUE_TEMPLATE_PATH_DEFAULT)
