...
CREATE_ISSUE_ISSUE_MANDATORY_PARAMETER= env.list(os.environ.get('CREATE_ISSUE_ISSUE_MANDATORY_PARAMETER',CREATE_ISSUE_ISSUE_MANDATORY_PARAMETER_DEFAULT))
CREATE_ISSUE_ISSUE_MANDATORY_FIELD= env.list(os.environ.get('CREATE_ISSUE_ISSUE_MANDATORY_FIELD',CREATE_ISSUE_ISSUE_MANDATORY_FIELD_DEFAULT))
CREATE_ISSUE_ISSUE_OTHER_FIELD= env.list(os.environ.get('CREATE_ISSUE_ISSUE_OTHER_FIELD',CREATE_ISSUE_ISSUE_OTHER_FIELD_DEFAULT))
