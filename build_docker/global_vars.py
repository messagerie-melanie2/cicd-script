...
BUILD_DOCKER_CI_PULL_REGISTRY_VARIABLE_NAME_DEFAULT = "CI_REGISTRY"
BUILD_DOCKER_CI_PULL_REGISTRY_USERNAME_DEFAULT = "cijobtoken"
BUILD_DOCKER_CI_PULL_REGISTRY_PASSWORD_VARIABLE_NAME_DEFAULT = "CI_REGISTRY_PASSWORD"
BUILD_DOCKER_CI_PUSH_REGISTRY_VARIABLE_NAME_DEFAULT = "CI_REGISTRY"
BUILD_DOCKER_CI_PUSH_REGISTRY_USERNAME_DEFAULT = "cijobtoken"
BUILD_DOCKER_CI_PUSH_REGISTRY_PASSWORD_VARIABLE_NAME_DEFAULT = "CI_REGISTRY_PASSWORD"
...
BUILD_DOCKER_CI_PULL_REGISTRY_VARIABLE_NAME = os.environ.get('BUILD_DOCKER_CI_PULL_REGISTRY_VARIABLE_NAME',BUILD_DOCKER_CI_PULL_REGISTRY_VARIABLE_NAME_DEFAULT)
BUILD_DOCKER_CI_PULL_REGISTRY = os.environ.get(BUILD_DOCKER_CI_PULL_REGISTRY_VARIABLE_NAME)
BUILD_DOCKER_CI_PULL_REGISTRY_USERNAME = os.environ.get('BUILD_DOCKER_CI_PULL_REGISTRY_USERNAME',BUILD_DOCKER_CI_PULL_REGISTRY_USERNAME_DEFAULT)
BUILD_DOCKER_CI_PULL_REGISTRY_PASSWORD_VARIABLE_NAME = os.environ.get('BUILD_DOCKER_CI_PULL_REGISTRY_PASSWORD_VARIABLE_NAME',BUILD_DOCKER_CI_PULL_REGISTRY_PASSWORD_VARIABLE_NAME_DEFAULT)
BUILD_DOCKER_CI_PULL_REGISTRY_PASSWORD = os.environ.get(BUILD_DOCKER_CI_PULL_REGISTRY_PASSWORD_VARIABLE_NAME)
BUILD_DOCKER_CI_PUSH_REGISTRY_VARIABLE_NAME = os.environ.get('BUILD_DOCKER_CI_PUSH_REGISTRY_VARIABLE_NAME',BUILD_DOCKER_CI_PUSH_REGISTRY_VARIABLE_NAME_DEFAULT)
BUILD_DOCKER_CI_PUSH_REGISTRY = os.environ.get(BUILD_DOCKER_CI_PUSH_REGISTRY_VARIABLE_NAME)
BUILD_DOCKER_CI_PUSH_REGISTRY_USERNAME = os.environ.get('BUILD_DOCKER_CI_PUSH_REGISTRY_USERNAME',BUILD_DOCKER_CI_PUSH_REGISTRY_USERNAME_DEFAULT)
BUILD_DOCKER_CI_PUSH_REGISTRY_PASSWORD_VARIABLE_NAME = os.environ.get('BUILD_DOCKER_CI_PUSH_REGISTRY_PASSWORD_VARIABLE_NAME',BUILD_DOCKER_CI_PUSH_REGISTRY_PASSWORD_VARIABLE_NAME_DEFAULT)
BUILD_DOCKER_CI_PUSH_REGISTRY_PASSWORD = os.environ.get(BUILD_DOCKER_CI_PUSH_REGISTRY_PASSWORD_VARIABLE_NAME)
