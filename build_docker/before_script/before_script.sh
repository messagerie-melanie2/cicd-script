...
readonly CI_PULL_REGISTRY=${CI_PULL_REGISTRY}
readonly CI_PULL_REGISTRY_USER=${CI_PULL_REGISTRY_USER}
readonly CI_PULL_REGISTRY_PASSWORD=${CI_PULL_REGISTRY_PASSWORD}
