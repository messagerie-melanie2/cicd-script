...
BUILDER_PROJECT_BRANCHS_DEFAULT = ["main"]
TAG_TO_KEEP_DEFAULT = ["latest"]
...
BUILDER_PROJECT_BRANCHS = env.list("BUILDER_PROJECT_BRANCHS",BUILDER_PROJECT_BRANCHS_DEFAULT)
TAG_TO_KEEP = env.list("REPOSITORIES_WHITELIST",TAG_TO_KEEP_DEFAULT)
