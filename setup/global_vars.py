...
SETUP_DEFAULT_SCHEDULE_DEFAULT = """{
        "description": "", 
        "cron": "", 
        "cron_timezone": "Europe/Paris",
        "variables":{}
...
SETUP_DEFAULT_SCHEDULE_RAW = os.environ.get('SETUP_DEFAULT_SCHEDULE',SETUP_DEFAULT_SCHEDULE_DEFAULT)
SETUP_DEFAULT_SCHEDULE = json.loads(SETUP_DEFAULT_SCHEDULE_RAW)
...
#Default value
SETUP_SCAN_FOLDER_PATH_DEFAULT = "setup/"
SETUP_SCAN_FILE_ENDSWITH_DEFAULT = "scan.yml"
SETUP_SONAR_TOKEN_VARIABLE_NAME_DEFAULT = "SONAR_TOKEN"

SETUP_SCAN_FOLDER_PATH = os.environ.get('SETUP_SCAN_FOLDER_PATH',SETUP_SCAN_FOLDER_PATH_DEFAULT)
SETUP_SCAN_FILE_ENDSWITH = os.environ.get('SETUP_SCAN_FILE_ENDSWITH',SETUP_SCAN_FILE_ENDSWITH_DEFAULT)
SETUP_SONAR_TOKEN_VARIABLE_NAME = os.environ.get('SETUP_SONAR_TOKEN_VARIABLE_NAME',SETUP_SONAR_TOKEN_VARIABLE_NAME_DEFAULT)
SETUP_SONAR_TOKEN = os.environ.get(SETUP_SONAR_TOKEN_VARIABLE_NAME, '')
