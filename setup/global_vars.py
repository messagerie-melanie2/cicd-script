...
SETUP_BUILD_DEFAULT_SCHEDULE_DEFAULT = """{
        "description": "", 
        "cron": "", 
        "cron_timezone": "Europe/Paris",
        "variables":{}
...
SETUP_BUILD_DEFAULT_SCHEDULE_RAW = os.environ.get('SETUP_BUILD_DEFAULT_SCHEDULE',SETUP_BUILD_DEFAULT_SCHEDULE_DEFAULT)
SETUP_BUILD_DEFAULT_SCHEDULE = json.loads(SETUP_BUILD_DEFAULT_SCHEDULE_RAW)
